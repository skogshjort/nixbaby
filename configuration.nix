...

{
  ...
  networking.interfaces.wwp0s29u1u5u3.useDHCP = true;
  ...
  environment.systemPackages = with pkgs; [
    ...
    luaPackages.lpeg
    (haskellPackages.ghcWithPackages (p : [p.QuickCheck p.gloss]))
    (python3.withPackages (p: [p.distro]))
    stack
    # vscode
    # jdk11 openjfx11

    spotifyd spotify-tui spotify
